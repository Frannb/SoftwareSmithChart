...
export default function datasetConstructionB(choice, z) {
    const y = math.divide(1, z)
    
    const values = points('B', choice, z)
    ...
    if (0 < choice && choice <= 2){
        return [
            ...
            {
                data: [values.point2, values.point3],
                borderWidth: 1,
                borderColor: 'rgb(255, 0, 0)',
                pointRadius: 0,
                pointHoverRadius: 0,
